...
hl.window_rule({
    match = {
        class = "equibop|org.quickshell|imv|swappy|krita|gimp|inkscape|darktable|resolve|kdenlive|shotcut|blender|godot|(steam_app_(default|[0-9]+))|gamescope",
    },
    tag = "+opaque_app",
})
...
-- Terminal Transparency Bypass
hl.window_rule({ match = { class = "foot" }, opacity = "1.0 override" })

-- Transparent File Manager
hl.window_rule({ match = { class = "thunar" }, opacity = "0.60 override" })
